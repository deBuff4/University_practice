...
with open("../../../Загрузки/dataset_v1.0/code_corpus.json", encoding="utf-8") as f:
    corpus = json.load(f)

with open("../../../Загрузки/dataset_v1.0/eval_questions.json", encoding="utf-8") as f:
    questions = json.load(f)

with open("../../../Загрузки/dataset_v1.0/categories.json", encoding="utf-8") as f:
